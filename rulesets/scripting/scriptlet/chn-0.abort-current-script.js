...
const argsList = ["[\"_0xodP\"]","[\"document.createElement\",\"b.onerror\"]","[\"alert\",\"typeof(ad)\"]","[\"jQuery\",\"\\\\u\"]","[\"document.writeln\",\"\\\\u\"]","[\"$\",\"#adisblock\"]","[\"document.getElementById\",\"/#myModal'\\\\)\\\\.modal/\"]","[\"setTimeout\",\"COOKIE_NAME\"]","[\"$\",\"adskilltest\"]","[\"document.getElementById\",\"/!document\\\\.getElementById\\\\([\\\\s\\\\S]*?\\\\.style\\\\.display=/\"]","[\"$\",\"!document.getElementById(btoa\"]","[\"jQuery\",\"injectPops\"]","[\"$\",\"infoid\"]","[\"document.write\",\"document.write(ad);\"]","[\"document.write\",\"tips\"]","[\"document.write\",\"/getCookie[\\\\s\\\\S]*?\\\\(\\\"\\\\\\\\x/\"]","[\"document.write\",\"/\\\\.(gif|php)/\"]","[\"window.leave\"]","[\"$\",\"popunder\"]"];

const hostnamesMap = new Map([["itdog.cn",0],["linovelib.com",1],["slit.cn",2],["jkpan.cc",[3,4]],["getrelax.cc",5],["poedb.tw",6],["bingfeng.tw",7],["youranshare.com",8],["getitfree.cn",9],["pg-wuming.com",10],["pornbest.org",11],["nunuyy3.org",12],["dogfight360.com",13],["o8tv.com",14],["javlibrary.com",15],["wnacg1.cc",16],["pixnet.net",17],["ggjav.com",18],["porn87.com",18]]);
