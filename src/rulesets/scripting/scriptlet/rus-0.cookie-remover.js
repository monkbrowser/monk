...
const argsList = ["[\"/^bda|^bltsr/\"]","[\"/^bltsr$|^JPIqApiY$|^specific$|^substantial$/\"]","[\"/adblock_/\"]","[\"isab\"]","[\"jtnews_adblock\"]","[\"yadb\"]"];

const hostnamesMap = new Map([["rg.ru",0],["sm.news",0],["ura.news",0],["yandex.by",1],["yandex.kz",1],["yandex.ru",1],["yandex.uz",1],["yapx.ru",2],["24smi.org",3],["e1.ru",4],["kakprosto.ru",5]]);
