...
const argsList = ["[\"wheel\",\"var r=\\\"deltaY\\\"in n?w\"]","[\"wheel\",\"[native code]\"]","[\"DOMContentLoaded\",\"cookieDetailsList\"]","[\"jentis.consent.engine.show-bar\",\"jentis.consent\"]","[\"touchmove\",\".preventDefault():void\"]","[\"DOMContentLoaded\",\"#vicky-cookiebox\"]","[\"DOMContentLoaded\",\"#insiderflyin--blur\"]"];

const hostnamesMap = new Map([["stuytown.com",0],["trustpid.com",1],["ifrs.org",2],["moemax.de",3],["tiktok.com",4],["poradnikbiznesu.info",5],["aerotelegraph.com",6]]);
